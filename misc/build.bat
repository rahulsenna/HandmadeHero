...
set CommonCompilerFlags=%Definitions% /nologo /FC /WX /W4 /wd4100 /wd4089 /wd4068 /wd4505 /diagnostics:column /wd4456 /wd4201 /wd4100 /wd4505 /wd4189 /wd4457 /MTd /Oi /Od /GR- /Gm- /EHa- /Zi
...
cl %CommonCompilerFlags% /Fmhandmade.map ..\cpp\code\handmade.cpp -LD /link -EXPORT:GameUpdateAndRender -EXPORT:GameGetSoundSamples -incremental:no -PDB:handmade_pdb_%random%.pdb
del lock.tmp
popd
